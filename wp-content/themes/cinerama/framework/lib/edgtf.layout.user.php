        ...
        <tr>
            ...
            <td class="edgtf-user-image-field">
                ...
                <p>
                    ...
                    <input data-userid="<?php echo esc_html( $_GET['user_id'] ); ?>" type="button" class="button button-secondary edgtf-user-media-remove" name="edgtf-user-media-remove" value="<?php esc_attr_e( 'Remove Image', 'cinerama' ); ?>"/>
                </p>
            </td>
        </tr>
		<?php
