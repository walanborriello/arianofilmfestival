                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="edgtf-media-uploader">
                                ...
                                <a class="edgtf-media-upload-btn btn btn-sm btn-primary" href="javascript:void(0)" data-frame-title="<?php esc_attr_e('Select File', 'cinerama'); ?>" data-frame-button-text="<?php esc_html_e('Select File', 'cinerama'); ?>"><?php esc_html_e('Upload', 'cinerama'); ?></a>
