...
if ( ! function_exists( 'cinerama_edge_add_font_elegant_icon_pack' ) ) {
	function cinerama_edge_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new CineramaEdgeClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_collection', 'cinerama_edge_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'cinerama_edge_add_font_elegant_icon_pack_option' ) ) {
	function cinerama_edge_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'cinerama' );
		
		return $options;
	}
	
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_options', 'cinerama_edge_add_font_elegant_icon_pack_option' );
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_social_options', 'cinerama_edge_add_font_elegant_icon_pack_option' );
}

class CineramaEdgeClassIconsFontElegant implements iCineramaEdgeInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
