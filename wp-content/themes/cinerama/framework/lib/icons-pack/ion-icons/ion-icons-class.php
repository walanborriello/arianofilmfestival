...
if ( ! function_exists( 'cinerama_edge_add_ion_icon_pack' ) ) {
	function cinerama_edge_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new CineramaEdgeClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_collection', 'cinerama_edge_add_ion_icon_pack' );
}

if ( ! function_exists( 'cinerama_edge_add_ion_icon_pack_option' ) ) {
	function cinerama_edge_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'cinerama' );
		
		return $options;
	}
	
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_options', 'cinerama_edge_add_ion_icon_pack_option' );
	add_filter( 'cinerama_edge_filter_add_icon_pack_into_social_options', 'cinerama_edge_add_ion_icon_pack_option' );
}

class CineramaEdgeClassIonIcons implements iCineramaEdgeInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
